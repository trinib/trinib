...
| **D1** | [E2](https://github.com/trinib/trinib/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+E2) |
...
| `E2` to `E4` | [ @apluquet](https://github.com/apluquet) |
| `Start game` | [ @apluquet](https://github.com/apluquet) |
...
<i>Last refresh</i> : <b>Wednesday, May 31st, 2023, 6:16:10 AM</b>
